...
public record CreateArtikelCommand(String merk, String code, String omschrijving, UUID leverancierId, int aantalInStock, int minimumInStock, BigDecimal aankoopPrijs, BigDecimal verkoopPrijs, BigDecimal actuelePrijs)  {
