package be.one16.barka.magazijn.adapter.in;

import be.one16.barka.BaseIntegrationTesting;
import be.one16.barka.magazijn.common.common.TestDataBuilder;
import be.one16.barka.magazijn.adapters.in.ArtikelController;
...
public class ArtikelControllerIntegrationTest extends BaseIntegrationTesting {
    ...
    public void testGetArtikelById() throws Exception {
        LeverancierJpaEntity createdLeverancier = leverancierRepository.save(TestDataBuilder.generateTestLeverancierJpaEntity("DYNAMIC BE"));
    ...
    public void testGetArtikelsFilteredAndPaginated() throws Exception {
        LeverancierJpaEntity createdLeverancierOne = leverancierRepository.save(TestDataBuilder.generateTestLeverancierJpaEntity("DYNAMIC BE"));
        LeverancierJpaEntity createdLeverancierTwo = leverancierRepository.save(TestDataBuilder.generateTestLeverancierJpaEntity("ABUS BE"));
