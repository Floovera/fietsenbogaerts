package be.one16.barka.magazijn.common;
...
public final class TestDataBuilder {
    ...
    public static ArtikelJpaEntity generateTestArtikelJpaEntity(ArtikelLeverancierJpaEntity leverancier, String code, String merk, String omschrijving) {
    ...
    public static ArtikelLeverancierJpaEntity generateTestLeverancierJpaEntity(String naam) {
        ArtikelLeverancierJpaEntity artikelLeverancierJpaEntity = new ArtikelLeverancierJpaEntity();

        artikelLeverancierJpaEntity.setUuid(randomUUID());
        artikelLeverancierJpaEntity.setNaam(naam);

        return artikelLeverancierJpaEntity;
    }
}