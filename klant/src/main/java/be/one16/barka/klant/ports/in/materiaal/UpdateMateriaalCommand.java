...
public record UpdateMateriaalCommand(UUID materiaalId, String artikelMerk, String artikelCode, String artikelOmschrijving, int aantalArtikels, double verkoopPrijsArtikel, int korting, int btwPerc, UUID verkoopId) {
