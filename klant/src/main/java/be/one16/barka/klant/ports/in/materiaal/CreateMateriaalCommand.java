...
public record CreateMateriaalCommand(UUID artikelId ,String artikelMerk, String artikelCode, String artikelOmschrijving, int aantalArtikels, double verkoopPrijsArtikel, int korting, int btwPerc, UUID verkoopId) {
