...
public record CreateMateriaalCommand(UUID artikelId , String artikelMerk, String artikelCode, String artikelOmschrijving, int aantalArtikels, BigDecimal verkoopPrijsArtikel, int korting, int btwPerc, UUID orderId) {
